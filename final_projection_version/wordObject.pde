class wordObject {
  ...
  wordObject(int _index, float _x, float _y, String _target, String _related, int _wordLength) {
    ...
    boxWidth = rightBound - leftBound;
    boxHeight = botBound - topBound;
  }
  ...
  void checkClicked(wordObject _tempWord) {
    if (mouseX - paddingX - plusPaddingX > _tempWord.leftBound && mouseX - paddingX - plusPaddingX< _tempWord.rightBound && mouseY - paddingY - plusPaddingY > _tempWord.topBound && mouseY - paddingY - plusPaddingY < _tempWord.botBound) {
